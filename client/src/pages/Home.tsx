...
const pricingPlans = [
  {
    ...
    period: "무료",
    icon: Zap,
    desc: "Virtual Speaker를 체험해보세요",
    features: ["월 3회 강의 생성", "기본 TTS 음성 5종", "기본 얼굴 프리셋 3종", "720p 영상 품질", "커뮤니티 지원"],
    cta: "무료로 시작",
    popular: false,
  },
  {
    ...
    period: "/월",
    icon: Crown,
    desc: "전문 강사를 위한 완전한 도구",
    features: ["무제한 강의 생성", "프리미엄 TTS 음성 20종", "전체 얼굴 프리셋 라이브러리", "1080p HD 영상 품질", "딥페이크 얼굴 변환", "음성 변조 & 말투 변환", "외부 플랫폼 연동 (Zoom 등)", "라이브 방송 기능", "우선 지원"],
    cta: "Pro 시작하기",
    popular: true,
  },
  {
    ...
    icon: Building2,
    desc: "기업 맞춤형 솔루션",
    features: ["Pro 전체 기능 포함", "4K 영상 품질", "커스텀 AI 모델 학습", "전용 서버 & API", "팀 관리 & 권한 설정", "SLA 보장 & 전담 매니저", "화이트라벨 지원", "온프레미스 배포 옵션"],
    cta: "영업팀 문의",
    popular: false,
  },
];
