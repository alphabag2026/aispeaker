    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="container max-w-5xl py-8">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-bold flex items-center gap-2"><Monitor className="h-6 w-6 text-primary" /> 외부 플랫폼 연동</h1>
            <p className="text-muted-foreground">Zoom, Google Meet, Webex 등에서 AI 강의를 송출합니다</p>
          </div>
        </div>
