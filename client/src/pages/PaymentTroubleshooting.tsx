        ...
        <Card className="mb-8 border-red-500/20 bg-red-500/5">
          <CardHeader>
            <CardTitle className="text-lg flex items-center gap-2">
              ...
              {t("pt.failureScenarios.title")} {/* Stripe 테스트 카드 실패 시나리오 */}
            </CardTitle>
                ...
                {expandedItems.has(scenario.id) && (
                  <div className="px-4 pb-4 space-y-3" onClick={(e) => e.stopPropagation()}>
                    <div className="rounded-md bg-red-500/10 border border-red-500/20 p-3">
                      <p className="text-xs font-semibold text-red-400 mb-1">{t("pt.failureScenarios.expectedError")} {/* 예상 에러 메시지 */}</p>
                    ...
                    <div className="rounded-md bg-green-500/10 border border-green-500/20 p-3">
                      <p className="text-xs font-semibold text-green-400 mb-1 flex items-center gap-1">
                        <CheckCircle className="w-3.5 h-3.5" /> {t("pt.failureScenarios.resolution")} {/* 해결 방법 */}
                      </p>
