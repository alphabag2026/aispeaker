...
### 강의 제작 워크플로우 가이드 툴팁
- [ ] StepGuideTooltip 컴포넌트 생성 (각 단계별 안내 팝오버)
- [ ] Step 1 (아바타 선택) 가이드 툴팁 추가
- [ ] Step 2 (스크립트) 가이드 툴팁 추가
- [ ] Step 3 (슬라이드) 가이드 툴팁 추가
- [ ] Step 4 (매칭 에디터) 가이드 툴팁 추가
- [ ] Step 5 (프리뷰) 가이드 툴팁 추가
- [ ] 첫 방문 시 자동 표시, 이후 ? 아이콘 클릭으로 재표시

### 아바타 커스터마이징 기능
- [ ] 아바타 선택 단계에서 커스터마이징 패널 추가
- [ ] 아바타 이름 편집 기능
- [ ] 아바타 역할(성격) 설정 기능
- [ ] TTS 음성 선택/변경 기능
- [ ] 얼굴 샘플 선택/변경 기능
